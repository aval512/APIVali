...
///////////////////////////////////
	...
	t.hide(), e.click(function(a) {
		...
		var i = $($(this).attr("href")),
			s = $(this);
		s.is("[disabled=disabled]") || (s.parent().prevAll().find("a").addClass("btn-primary"), 
		s.parent().nextAll().find("a").removeClass("btn-primary"), e.removeClass("active").addClass("btn-default"), 
		s.addClass("active"), t.hide(), i.show(), i.find("input:eq(0)").focus())
	}), a.click(function() {
		...
		$(this).hasClass("fa-eye") ? ($(this).removeClass("fa-eye").addClass("fa-eye-slash"), 
		$(this).parent().find("input").attr("type", "text")) : ($(this).removeClass("fa-eye-slash").addClass("fa-eye"), 
